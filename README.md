...
| :--- | :--- | :--- | :--- | :--- |
| **从者卡面** (`CharaGraph`) | `Figure/CharaGraph/` | `.mp4`, `.webp`, `.png`,`.astc`, `.astc.zstd`| `mp4` → `webp` → `png` | - |
| **窄卡面** (`NarrowFigure`) | `Figure/NarrowFigure/` | `.mp4`, `.webp`, `.png`,`.astc`, `.astc.zstd`| `mp4` → `webp` → `png` | 四角切角 |
