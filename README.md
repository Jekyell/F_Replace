...
| :--- | :--- | :--- | :--- | :--- |
| **从者卡面** (`CharaGraph`) | `Figure/CharaGraph/` | `.mp4`, `.webp`, `.png` | `mp4` → `webp` → `png` | 支持动态卡面 |
...
1. **从者卡面与头像**
   - **命名规范**：`[从者 ID]@[突破数]`（突破数范围 `1`~`4`，灵衣从 `11` 开始）。例如 `4000100@4.png`（奥尔加玛丽满破卡面）。
